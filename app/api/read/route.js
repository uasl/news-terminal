...
import { sources } from '../../../lib/sources'; // <-- YOL DÜZELTİLDİ
...
export async function GET(request) {
  ...
  try {
    ...
    if (html.includes('{"error":') || html.length < 500) throw new Error("Blocked");
      ...
      async start(controller) {
        ...
        try {
          const systemPrompt = `
            ...
            Rewrite this news article into a "Strategic Brief" in ${targetLanguage}.
            
            REQUIRED OUTPUT STRUCTURE:
            <h1>[TRANSLATED HEADLINE HERE]</h1>
            <p><b>The Big Picture:</b> [Translate/Rewrite the core event (subheadline) in 2 sentences.]</p>
