export const sources = [
  ...
  { id: 'e-us-5', name: 'Harvard Biz Rev', category: 'economics', region: 'us', url: 'https://hbr.org/feed' },
  { id: 'e-us-6', name: 'Inc. Magazine', category: 'economics', region: 'us', url: 'https://www.inc.com/rss' },
  
  { id: 'e-gl-1', name: 'Fortune', category: 'economics', region: 'row', url: 'https://fortune.com/feed' },
  { id: 'e-gl-2', name: 'Quartz', category: 'economics', region: 'row', url: 'https://cms.qz.com/feed/' },
  { id: 'e-gl-3', name: 'Global Issues', category: 'economics', region: 'row', url: 'https://www.globalissues.org/news/feed' },
  
  { id: 'e-eu-1', name: 'Euractiv', category: 'economics', region: 'eu', url: 'https://www.euractiv.com/section/economy-jobs/feed/rss' },
  { id: 'e-eu-2', name: 'Capital.fr', category: 'economics', region: 'eu', url: 'https://www.capital.fr/feed' },
];